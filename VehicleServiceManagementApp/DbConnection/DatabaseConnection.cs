...
namespace VehicleServiceManagementApp.DbConnection
{
    class DatabaseConnection
    {
        ...
        public SqlDataReader GetAppoinmnetMails(String tommorrow, String after)
        {
            ...
            String query = "SELECT * from dbo.Appoinment ap , dbo.Customer cu where ap.cusId LIKE cu.cusId AND ap.dateApp >= '"+tommorrow+"' AND ap.dateApp <= '"+after+"' AND ap.emailStatus = 'Not sent'";
